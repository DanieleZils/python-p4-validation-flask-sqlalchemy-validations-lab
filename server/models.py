...
# All authors have a name.- column name, nullable=false
# No two authors have the same name.-unique=True
# Author phone numbers are exactly ten digits.=column, integer, 
